...
print("\n" + "=" * 80 + "\nFINE-TUNED: kevpower/holos-medyk-merged-v3\n" + "=" * 80, flush=True)
tok2 = AutoTokenizer.from_pretrained("kevpower/holos-medyk-merged-v3")
m2 = AutoModelForCausalLM.from_pretrained("kevpower/holos-medyk-merged-v3", torch_dtype=torch.bfloat16, device_map="auto")
m2.eval()
